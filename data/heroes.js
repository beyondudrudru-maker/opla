 ...
 * ────────────────────────────────────────────────────────
 *  - supportFocus: string
 *      Who this hero's talent/ability actually buffs. Primary value is
 *      derived from talent.targets/ability.targets ("Mage" -> "Mage
 *      Troops", "All Allies" -> "All Troops", etc.), with a secondary
 *      "(+ X, Y)" suffix pulled from this hero's membership in
 *      synergies.js's heroSynergyIndex utility categories (healing,
 *      shielding, crowdControl, debuffers, evasionBuff, summoners,
 *      bossDamage) so the label stays grounded in already-curated data.
 *  - recommendedTroops: string[]
...
const heroes = [
  ...
  },
  {
    ...
    "supportFocus": "Mage Troops (+ Crowd-Control)",
    "recommendedTroops": [
      "Phoenix",
      "Lava Golem",
      "Shaman",
  ...
  },
  {
    ...
    "supportFocus": "Self (Summons Allies) (+ Ally Summons)",
    "recommendedTroops": [
      "Steel Revenant",
      "Axe Throwers",
      "Imp"
  ...
  },
  {
    ...
    "supportFocus": "All Troops (Utility) (+ Crowd-Control)",
    "recommendedTroops": [
      "Steel Revenant",
      "Axe Throwers",
      "Imp"
  ...
  },
  {
    ...
    "supportFocus": "All Troops (+ Healing, Ally Summons)",
    "recommendedTroops": [
      "Steel Revenant",
      "Axe Throwers",
      "Imp"
  ...
  "realGear": {
    ...
    "weapon": null,
    "armor": null,
    "note": "No confirmed real gear data yet for the Ranger role family."
  }
  },
  {
    "id": "REMUS_01",
    ...
    "supportFocus": "All Troops (+ Shielding, Boss Damage)",
    "recommendedTroops": [
      "Steel Revenant",
      "Axe Throwers",
      "Imp"
  ...
  },
  {
    ...
    "supportFocus": "Enemy Control (Debuff)",
    "recommendedTroops": [
      "Immortal",
      "Cursed Catapult",
      "Night Hunter"
  ...
  },
  {
    ...
    "supportFocus": "Enemy Control (Debuff) (+ Enemy Debuffs, Ally Summons)",
    "recommendedTroops": [
      "Immortal",
      "Cursed Catapult",
      "Night Hunter"
  ...
  },
  {
    ...
    "supportFocus": "All Troops (+ Crowd-Control, Enemy Debuffs)",
    "recommendedTroops": [
      "Bonebreaker",
      "Alchemist",
      "Assassins"
  ...
  },
  {
    ...
    "supportFocus": "All Troops (+ Crowd-Control, Evasion Buff)",
    "recommendedTroops": [
      "Lava Golem",
      "Shaman",
      "Storm Mistresses"
  ...
  },
  {
    ...
    "supportFocus": "Undead Troops (+ Ally Summons)",
    "recommendedTroops": [
      "Immortal",
      "Headless",
      "Cursed Catapult",
  ...
  },
  {
    ...
    "supportFocus": "Mage Troops (+ Crowd-Control, Evasion Buff, Ally Summons)",
    "recommendedTroops": [
      "Phoenix",
      "Lava Golem",
      "Shaman",
  ...
  },
  {
    ...
    "supportFocus": "Mage Troops (+ Enemy Debuffs)",
    "recommendedTroops": [
      "Phoenix",
      "Lava Golem",
      "Shaman",
  ...
  },
  {
    ...
    "supportFocus": "Economy / Utility (Gold Generation)",
    "recommendedTroops": [
      "Bonebreaker",
      "Alchemist",
      "Assassins"
